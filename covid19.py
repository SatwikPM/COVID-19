...
#############################################################################
mapbox_access_token = 'pk.eyJ1Ijoic2F0d2lrbXV0aGFwcGEiLCJhIjoiY2s5b2syaTEyMDFkYTNrb2I0eGYxbGV0dyJ9.MSdqGPtgohjEU3LLpxyUmg'
        ...
        html.Div(
            [
                ...
                html.Div([html.Span('Dashboard: Covid-19 outbreak. (Updated once a day, based on consolidated last day total) Last Updated: ',
                        ...
                        html.Span(datatime_convert(df_confirmed.columns[-1],1) + '  00:01 (IST).',
